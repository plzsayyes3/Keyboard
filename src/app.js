...
const root = document.querySelector('#app'); const layoutPaths = ['data/layouts/naginata-v18.json?v=20260919-logic7', 'data/layouts/user-current.json?v=20260919-logic7']; const lessonPaths = ['data/lessons/basic.json', 'data/lessons/words.json', 'data/lessons/sentences.json'];
